...
import {interfaceNameListUsingGET} from "@/services/hlApi-backend/interfaceInfoController";
import {listTopInterfaceInfoInvokeUsingGET} from "@/services/hlApi-backend/analysisController";
import {payInterfaceUsingPOST} from "@/services/hlApi-backend/userInterfaceInfoController";
...
const StepForm: React.FC<Record<string, any>> = () => {
    ...
    return (
      <PageContainer content="为用户充值接口使用次数">
        <Card bordered={false}>
          <StepsForm
            current={current}
          ...
          >
            ...
            <StepsForm.StepForm
              ...
              onFinish={async (values) => {
                ...
                const payInterfaceParams: API.payInterfaceUsingPOSTParams = {};
                payInterfaceParams.interfaceName = params.interfaceName;
                payInterfaceParams.num = params.num;
                payInterfaceParams.payAccount = params.payAccount;
                payInterfaceParams.adminPsd = values.password;
                const result = await payInterfaceUsingPOST(payInterfaceParams);
                if (result.code !== 0) {
