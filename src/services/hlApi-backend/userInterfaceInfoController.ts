...
/** payInterface POST /api/interfaceInfo/payInterface */
export async function payInterfaceUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.payInterfaceUsingPOSTParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseobject>('/api/interfaceInfo/payInterface', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** selfInterfaceData GET /api/interfaceInfo/selfInterfaceData */
export async function selfInterfaceDataUsingGET(options?: { [key: string]: any }) {
  return request<API.BaseResponseListSelfInterfaceDateVo>(
    '/api/interfaceInfo/selfInterfaceData',
    {
      method: 'GET',
      ...(options || {}),
    },
